...
export default function NewsCard({
  ...
  return (
    <div
      className='w-full max-w-sm py-4 transition-all duration-300 ease-in-out cursor-pointer focus:ring hover:sm:border-purple-400 px-3.5 border-b border-stone-200 group'
